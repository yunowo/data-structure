...
class Ui_main_window(object):
    def setupUi(self, main_window):
        ...
        self.bar_graph_container = QtWidgets.QVBoxLayout(self.verticalLayoutWidget)
        self.bar_graph_container.setContentsMargins(0, 0, 0, 0)
        self.bar_graph_container.setObjectName("bar_graph_container")
        ...
        self.cloud_button = QtWidgets.QPushButton(self.tab_cloud)
        self.cloud_button.setObjectName("cloud_button")
        self.tab_cloud_container.addWidget(self.cloud_button, 1, 0, 1, 1)
        icon12 = QtGui.QIcon()
        ...
        self.tabs_container.setCurrentIndex(3)
    ...
    def retranslateUi(self, main_window):
        ...
        self.cloud_button.setText(_translate("main_window", "Refresh"))
