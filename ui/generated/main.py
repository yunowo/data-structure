...
class Ui_main_window(object):
    def setupUi(self, main_window):
        ...
        self.checkbox_phrase = QtWidgets.QCheckBox(self.tab_index)
        self.checkbox_phrase.setChecked(True)
        self.checkbox_phrase.setObjectName("checkbox_phrase")
        self.top_0.addWidget(self.checkbox_phrase)
    ...
    def retranslateUi(self, main_window):
        ...
        self.edit_index.setPlaceholderText(_translate("main_window", "关键词组"))
        self.checkbox_phrase.setText(_translate("main_window", "词组"))
