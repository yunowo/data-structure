...
class SortFilterModel(QSortFilterProxyModel):
    ...
    def data(self, index, role=Qt.DisplayRole):
        ...
        return super(SortFilterModel, self).data(index, role)
    ...
    def filterAcceptsRow(self, row, parent):
        ...
        return super(SortFilterModel, self).filterAcceptsRow(row, parent)
    ...
    def lessThan(self, index1, index2):
        ...
        return super(SortFilterModel, self).lessThan(index1, index2)
